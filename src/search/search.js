...
function searchCompany(searchText,updateResult){
    ...
    var data = JSON.stringify({
      ...
      var config = {
        method: 'post',
        url: 'https://company-store-frontend.herokuapp.com/search-company',
        headers: { 
...
function Search() {
    ...
    function storeCompanyInDB(companyDetails,setCompanyData){
        ...
        var data = JSON.stringify({
          ...
          var config = {
            method: 'post',
            url: 'https://company-store-frontend.herokuapp.com/store-company',
            headers: { 
              'Content-Type': 'application/json'
            },
            data : data
    ...
    useEffect(()=>{
        ...
        var config = {
            method: 'get',
            url: 'https://company-store-frontend.herokuapp.com/list-company'
          };
